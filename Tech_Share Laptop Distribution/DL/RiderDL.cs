...
{
    public static class RiderDL
    {
        public static List<RiderBL> RidersList = new List<RiderBL>();

        // Node Class For Double LinkList
        private class Node
        {

            internal RiderBL Value;
            internal Node next;
            internal Node prev;

            public Node(RiderBL value, Node prev, Node next)
            {
                this.Value = value;
                this.prev = prev;
                this.next = next;
        ...
        */
        ...
        public static void Insert(RiderBL value)
        {
        ...
        */
        ...
        /*  
            ...
            Time complexity: O(n)
        */
        public static bool ContainsEmail(RiderBL value)
        {
            Node temp = Head;
            while (temp != null)
            {
        ...
        public static bool ContainsName(RiderBL value)
        {
            Node temp = Head;
            while (temp != null)
            {
        ...
        public static bool ContainsCNIC(RiderBL value)
        {
            Node temp = Head;
            while (temp != null)
            {
        ...
        public static bool ContainsNumber(RiderBL value)
        {
            Node temp = Head;
            while (temp != null)
            {
        ...
        /*  
            ...
            Time complexity: O(n)
        */
        public static int GetIndex(RiderBL value)
        {
            Node temp = Head;
        ...
        */
        ...
        /*  
            ...
            Time complexity: O(n).
        */
        public static RiderBL DeleteByValue(RiderBL value)
        {
            ...
            // Declare a container variable for the value of the RiderBL
            RiderBL toBeDeleted;
        ...
        */
        public static RiderBL Pop()
        {
            ...
            RiderBL toBeDeleted = Head.Value;
        ...
        /*  
            ...
            Time complexity: O(n).
        */
        public static void InsertAtEnd(RiderBL value)
        {
            if (Equals(Head, null))
            {
                Insert(value);
        ...
        */
        ...
        //  Delete Rider 
        public static void DeleteRider(RiderBL employee)
        {
            for (int i = 0; i < RidersList.Count; i++)
            {
                if (employee.Name == RidersList[i].Name)
                {
                    RidersList.Remove(RidersList[i]);
                }
            }
        }
        ...
        public static void LoadFromCSV()
        {
            ...
            if (File.Exists(path))
            {
                using (var reader = new StreamReader("RidersData.csv"))
                {
                    string Name;
                    string Cnic;
                    string Email;
                    ...
                    while (!reader.EndOfStream)
                    {
                        ...
                        gender = values[6];
                        RiderBL temp = new RiderBL(Name, Cnic, Email, Phone_no, Address, salary, gender);
                        RidersList.Add(temp);
                        InsertAtEnd(temp);
                    }
                }
        ...
        public static void addintofileList()
        {
            ...
            foreach (RiderBL i in RidersList)
            {
        ...
        public static bool updateInfo(RiderBL temp)
        {
            Node Temp = Head;
