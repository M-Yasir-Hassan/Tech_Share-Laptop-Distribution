...
namespace Tech_Share_Laptop_Distribution
{
    ...
    {
        RiderBL obj = new RiderBL();
        public UpdateRider(RiderBL temp)
        {
            InitializeComponent();
            obj = temp;
        }
        ...
        private void BtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (chk)
            {
                RiderBL update = new RiderBL(obj.Name, cnic, email, phoneNumber, address, salary, obj.Gender);
                ...
                {
                    bool checkUpdate = RiderDL.updateInfo(update);
                    RiderDL.addintofileList();
                    if (checkUpdate)
                    {
                        MessageBox.Show("Successfully Updated Rider's Data", "Congratulation", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        txtCnic.Clear();
                        txtEmail.Clear();
